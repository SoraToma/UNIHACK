...
def main() -> None:
    ...
    collection = create_collection(database, "game_data")

    # Adjusted lambda function to match your sample data structure
    upload_json_data(
        collection,
        "steam_games.json",
        lambda data: (
            ...
            f"appid: {data.get('appid', 'Unknown')} | "
            f"name: {data.get('name', 'Unknown')} | "
            f"release_date: {data.get('release_date', 'Unknown')} | "
